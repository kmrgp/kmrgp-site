...
const ERROR_KEY_MAP: Record<string, DictKey> = {
  ...
  "Registration requires payment. Please complete the QR payment step on the signup form.": "auth.err.paymentRequired",
  "Payment screenshot not uploaded yet.": "auth.err.screenshotRequired",
